...
3. **Set Up Database Access (Credentials)**:
   ...
   - Set a Username (e.g., `gatherlydmin`) and a Password (e.g., `gatherlypassword`). **Remember these.**
   - Click **Add User**.
...
5. **Get Your Connection String**:
   ...
   - Copy the connection string provided. It will look something like this:
     `mongodb+srv://gatherlydmin:<password>@cluster0.xxxxx.mongodb.net/?retryWrites=true&w=majority`
...
5. Generate a new App Password (select "Other" and name it "Gatherly").
...
MONGO_URI=mongodb+srv://gatherlydmin:your_actual_password@cluster0.xxxxx.mongodb.net/gatherly?retryWrites=true&w=majority
...
I have included an export file named `Gatherly_Postman_Collection.json` in the root of the project. This contains every API route pre-configured.

1. Open [Postman](https://www.postman.com/downloads/).
2. Click **Import** (top left).
3. Drag and drop the `Gatherly_Postman_Collection.json` file into the window.
